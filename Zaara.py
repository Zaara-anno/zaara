...
\033[1;91m☞ Auther     : Zaara_Faraz
\033[1;92m☞ Nick name   : The fox
\033[1;95m☞ love   : Ethical hacking
...
def mb():
	...
	if bm =='':
	    ...
	    psb('Most wellcome to the fox world✓')
	    psb('WellCome To Zaara_Anno')
	    psb('Congratulations Zaara_Anno Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Zaara✓')
	    psb('🔓Password ☆ Anno✓')
	    psb('Subscrib My video✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Zaara_anno && python2 B4.py')
	elif bm =='3':
